...
class sg_semerak_pasir_putih extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        <div className="page-header">
                            <center>
                              <h1>Sg.Semerak di Pasir Putih</h1><br/>
                ...
                <StageRegression station="Sg.Semerak di Pasir Putih" normal="0.40" alert="2.00" warning="2.30" danger="3.00"/>
                <RainfallCorrelation station="Sg.Semerak di Pasir Putih"  normal="0.40" alert="2.00" warning="2.30" danger="3.00"/>
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  />
                    ...
                    <PastRecord date={moment(this.state.startDate).format('D/M/YYYY')} station="Sg.Lebir di Tualang"  normal="0.40" alert="2.00" warning="2.30" danger="3.00"/>
...
export default sg_semerak_pasir_putih;

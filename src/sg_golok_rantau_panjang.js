...
class sg_golok_rantau_panjang extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        <div className="page-header">
                            <center>
                              <h1>Sg. Golok di Rantau Panjang</h1><br/>
                ...
                <StageRegression station="Empangan Bukit Kwong" normal="16.76" alert="17.22" warning="17.37" danger="17.72"/>
                <RainfallCorrelation station="Empangan Bukit Kwong" normal="16.76" alert="17.22" warning="17.37" danger="17.72"/>
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  />
                    ...
                    <PastRecord date={moment(this.state.startDate).format('D/M/YYYY')} station="Empangan Bukit Kwong" normal="16.76" alert="17.22" warning="17.37" danger="17.72"/>
...
export default sg_golok_rantau_panjang;

  ...
  render() {
    ...
    return (
      ...
      <div className="container">
                ...
                <StageRegression station="Sg.Kelantan di Jeti Kastam" normal="1.00" alert="3.00" warning="4.00" danger="5.00"/>
                <RainfallCorrelation station="Sg.Kelantan di Jeti Kastam" normal="1.00" alert="3.00" warning="4.00" danger="5.00"/>
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  />
                    ...
                    <PastRecord date={moment(this.state.startDate).format('D/M/YYYY')} station="Sg.Kelantan di Jeti Kastam" normal="1.00" alert="3.00" warning="4.00" danger="5.00"/>

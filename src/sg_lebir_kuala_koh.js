...
class sg_lebir_kuala_koh extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        <div className="page-header">
                            <center>
                              <h1>Sg. Lebir di Kuala Koh</h1><br/>
                ...
                <StageRegression station="Sg. Lebir di Kuala Koh" normal="62.00" alert="67.00" warning="71.00" danger="75.00"/>
                <RainfallCorrelation station="Sg. Lebir di Kuala Koh" normal="62.00" alert="67.00" warning="71.00" danger="75.00"/>
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  />
                    ...
                    <PastRecord date={moment(this.state.startDate).format('D/M/YYYY')} station="Sg. Lebir di Kuala Koh" normal="62.00" alert="67.00" warning="71.00" danger="75.00"/>
...
export default sg_lebir_kuala_koh;

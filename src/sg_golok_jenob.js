...
class sg_golok_jenob extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="container">
                ...
                <StageRegression station="Sg.Golok di Jenob" normal="19.00" alert="21.50" warning="22.50" danger="23.50"/>
                <RainfallCorrelation station="Sg.Golok di Jenob" normal="19.00" alert="21.50" warning="22.50" danger="23.50"/>
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  />
                    ...
                    <PastRecord date={moment(this.state.startDate).format('D/M/YYYY')} station="Sg.Golok di Jenob" normal="19.00" alert="21.50" warning="22.50" danger="23.50"/>

      ...
      <div className="container">
                    ...
                    <h3>Stage Regression</h3>
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <i className="clip-stats"></i> Sg. Golok di Kuala Jambu Station Regression Chart
                ...
                <div className="row">
                    ...
                    <h3>Rainfall Correlation</h3>
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <i className="clip-stats"></i> Sg. Golok di Kuala Jambu Station Rainfall Chart
                                <div className="panel-tools">
                ...
                <div className="row">
                    ...
                    <h3>Tank Model</h3>
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <i className="clip-stats"></i> Sg. Golok di Kuala Jambu Station Tank Model Chart
                                <div className="panel-tools">
                                    <a className="btn btn-xs btn-link panel-collapse collapses" href="index.html#">
                                    </a>
                                </div>
                ...
                <div className="row">
                    ...
                    <h3>Unit Hydrograph</h3>
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <i className="clip-stats"></i> Sg. Golok di Kuala Jambu Station Unit Hydrograph Chart
                                <div className="panel-tools">
                                    <a className="btn btn-xs btn-link panel-collapse collapses" href="index.html#">
                                    </a>
                                </div>

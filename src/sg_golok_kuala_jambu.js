...
class sg_golok_kuala_jambu extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        <div className="page-header">
                            <center>
                              <h1>Sg.Golok di Kuala Jambu</h1><br/>
                ...
                <StageRegression station="Sg.Golok di Kuala Jambu" normal="0.70" alert="2.00" warning="2.15" danger="2.50"/>
                <RainfallCorrelation station="Sg.Golok di Kuala Jambu" normal="0.70" alert="2.00" warning="2.15" danger="2.50"/>
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  />
                    ...
                    <PastRecord date={moment(this.state.startDate).format('D/M/YYYY')} station="Sg.Golok di Kuala Jambu" normal="0.70" alert="2.00" warning="2.15" danger="2.50"/>
...
export default sg_golok_kuala_jambu;

...
class sg_kelantan_kuala_krai extends Component {
  ...
  componentDidMount() {
    ...
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=00:00&date='+ this.state.DateComponent).then(function (response) {self.setState({twelveAM : response.data[0].water_level, forecast_twelveAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=01:00&date='+ this.state.DateComponent).then(function (response) {self.setState({oneAM : response.data[0].water_level, forecast_oneAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=02:00&date='+ this.state.DateComponent).then(function (response) {self.setState({twoAM : response.data[0].water_level, forecast_twoAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=03:00&date='+ this.state.DateComponent).then(function (response) {self.setState({threeAM : response.data[0].water_level, forecast_threeAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=04:00&date='+ this.state.DateComponent).then(function (response) {self.setState({fourAM : response.data[0].water_level, forecast_fourAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=05:00&date='+ this.state.DateComponent).then(function (response) {self.setState({fiveAM : response.data[0].water_level, forecast_fiveAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=06:00&date='+ this.state.DateComponent).then(function (response) {self.setState({sixAM : response.data[0].water_level, forecast_sixAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=07:00&date='+ this.state.DateComponent).then(function (response) {self.setState({sevenAM : response.data[0].water_level, forecast_sevenAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=08:00&date='+ this.state.DateComponent).then(function (response) {self.setState({eightAM : response.data[0].water_level, forecast_eightAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=09:00&date='+ this.state.DateComponent).then(function (response) {self.setState({nineAM : response.data[0].water_level, forecast_nineAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=10:00&date='+ this.state.DateComponent).then(function (response) {self.setState({tenAM : response.data[0].water_level, forecast_tenAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=11:00&date='+ this.state.DateComponent).then(function (response) {self.setState({elevenAM : response.data[0].water_level, forecast_elevenAM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=12:00&date='+ this.state.DateComponent).then(function (response) {self.setState({twelvePM : response.data[0].water_level, forecast_twelvePM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=13:00&date='+ this.state.DateComponent).then(function (response) {self.setState({onePM : response.data[0].water_level, forecast_onePM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=14:00&date='+ this.state.DateComponent).then(function (response) {self.setState({twoPM : response.data[0].water_level, forecast_twoPM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=15:00&date='+ this.state.DateComponent).then(function (response) {self.setState({threePM : response.data[0].water_level, forecast_threePM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=16:00&date='+ this.state.DateComponent).then(function (response) {self.setState({fourPM : response.data[0].water_level, forecast_fourPM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=17:00&date='+ this.state.DateComponent).then(function (response) {self.setState({fivePM : response.data[0].water_level, forecast_fivePM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=18:00&date='+ this.state.DateComponent).then(function (response) {self.setState({sixPM : response.data[0].water_level, forecast_sixPM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=19:00&date='+ this.state.DateComponent).then(function (response) {self.setState({sevenPM : response.data[0].water_level, forecast_sevenPM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=20:00&date='+ this.state.DateComponent).then(function (response) {self.setState({eightPM : response.data[0].water_level, forecast_eightPM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=21:00&date='+ this.state.DateComponent).then(function (response) {self.setState({ninePM : response.data[0].water_level, forecast_ninePM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=22:00&date='+ this.state.DateComponent).then(function (response) {self.setState({tenPM : response.data[0].water_level, forecast_tenPM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
    axios.get('https://banjirv2.herokuapp.com/Kelantan?station_name=Sg.Kelantan%20di%20Kuala%20Krai&time=23:00&date='+ this.state.DateComponent).then(function (response) {self.setState({elevenPM : response.data[0].water_level, forecast_elevenPM: response.data[0].rainfall_forecast});}).catch(function (error) {console.log(error);});
  ...
  render() {
    ...
    let current_status = self.state.current_status.map((index) =>
        ...
        <td className="center">{index.rainfall_forecast}</td>

      ...
      <div className="container">
                    ...
                    <h3>Stage Regression</h3>
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <i className="clip-stats"></i> Empangan Bukit Kwong Station Regression Chart
                ...
                <div className="row">
                    ...
                    <h3>Rainfall Correlation</h3>
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <i className="clip-stats"></i> Empangan Bukit Kwong Station Rainfall Chart
                                <div className="panel-tools">
                ...
                <div className="row">
                    ...
                    <h3>Tank Model</h3>
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <i className="clip-stats"></i> Empangan Bukit Kwong Station Tank Model Chart
                                <div className="panel-tools">
                                    <a className="btn btn-xs btn-link panel-collapse collapses" href="index.html#">
                                    </a>
                                </div>
                ...
                <div className="row">
                    ...
                    <h3>Unit Hydrograph</h3>
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <i className="clip-stats"></i> Empangan Bukit Kwong Station Unit Hydrograph Chart
                                <div className="panel-tools">
                                    <a className="btn btn-xs btn-link panel-collapse collapses" href="index.html#">
                                    </a>
                                </div>

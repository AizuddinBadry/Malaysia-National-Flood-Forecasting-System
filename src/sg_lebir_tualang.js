  ...
  render() {
    ...
    return (
      ...
      <div className="container">
                ...
                <StageRegression station="Sg.Lebir di Tualang" normal="23.00" alert="27.00" warning="31.00" danger="35.00"/>
                <RainfallCorrelation station="Sg.Lebir di Tualang" normal="23.00" alert="27.00" warning="31.00" danger="35.00"/>
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  />
                    ...
                    <PastRecord date={moment(this.state.startDate).format('D/M/YYYY')} station="Sg.Lebir di Tualang" normal="23.00" alert="27.00" warning="31.00" danger="35.00"/>
